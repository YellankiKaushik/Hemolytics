                ...
                <div className="max-w-6xl mx-auto px-4 lg:px-6 py-10 lg:py-14">
                    <div className="grid grid-cols-1 lg:grid-cols-5 gap-8 items-center">
                        <div className="lg:col-span-3">
                            ...
                            <h1 className="text-3xl lg:text-5xl font-bold text-gray-950 leading-tight" style={{ fontFamily: 'Space Grotesk' }}>
                                Hemolytics
                            </h1>
                            <p className="mt-2 text-lg lg:text-xl text-gray-800 font-semibold" style={{ fontFamily: 'Space Grotesk' }}>
                        ...
                        <div className="lg:col-span-2 bg-gray-950 rounded-xl p-5 text-white shadow-lg">
